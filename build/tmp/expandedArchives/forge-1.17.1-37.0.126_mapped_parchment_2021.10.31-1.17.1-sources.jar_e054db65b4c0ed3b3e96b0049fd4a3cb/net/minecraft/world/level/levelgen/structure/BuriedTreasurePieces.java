...
public class BuriedTreasurePieces {
   public static class BuriedTreasurePiece extends StructurePiece {
      ...
      public BuriedTreasurePiece(ServerLevel pLevel, CompoundTag pTag) {
      ...
      public boolean postProcess(WorldGenLevel pLevel, StructureFeatureManager pStructureManager, ChunkGenerator pChunkGenerator, Random pRandom, BoundingBox pBox, ChunkPos pChunkPos, BlockPos pPos) {
         ...
         while(blockpos$mutableblockpos.getY() > pLevel.getMinBuildHeight()) {
            ...
            if (blockstate1 == Blocks.SANDSTONE.defaultBlockState() || blockstate1 == Blocks.STONE.defaultBlockState() || blockstate1 == Blocks.ANDESITE.defaultBlockState() || blockstate1 == Blocks.GRANITE.defaultBlockState() || blockstate1 == Blocks.DIORITE.defaultBlockState()) {
               ...
               return this.createChest(pLevel, pBox, pRandom, blockpos$mutableblockpos, BuiltInLootTables.BURIED_TREASURE, (BlockState)null);
            }
