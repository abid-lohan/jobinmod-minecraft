...
public class LegacyStructureDataHandler {
   ...
   public void removeIndex(long pChunkValue) {
      for(String s : this.legacyKeys) {
         ...
         if (structurefeatureindexsaveddata != null && structurefeatureindexsaveddata.hasUnhandledIndex(pChunkValue)) {
            structurefeatureindexsaveddata.removeIndex(pChunkValue);
