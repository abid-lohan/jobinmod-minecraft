...
public class OceanMonumentPieces {
   ...
   static class FitDoubleXRoom implements OceanMonumentPieces.MonumentRoomFitter {
      ...
      public OceanMonumentPieces.OceanMonumentPiece create(Direction pDirection, OceanMonumentPieces.RoomDefinition pDefinition, Random pRandom) {
         pDefinition.claimed = true;
         pDefinition.connections[Direction.EAST.get3DDataValue()].claimed = true;
         return new OceanMonumentPieces.OceanMonumentDoubleXRoom(pDirection, pDefinition);
      }
   }
   ...
   static class FitDoubleXYRoom implements OceanMonumentPieces.MonumentRoomFitter {
      ...
      public OceanMonumentPieces.OceanMonumentPiece create(Direction pDirection, OceanMonumentPieces.RoomDefinition pDefinition, Random pRandom) {
         ...
         return new OceanMonumentPieces.OceanMonumentDoubleXYRoom(pDirection, pDefinition);
      }
   }
   ...
   static class FitDoubleYRoom implements OceanMonumentPieces.MonumentRoomFitter {
      ...
      public OceanMonumentPieces.OceanMonumentPiece create(Direction pDirection, OceanMonumentPieces.RoomDefinition pDefinition, Random pRandom) {
         pDefinition.claimed = true;
         pDefinition.connections[Direction.UP.get3DDataValue()].claimed = true;
         return new OceanMonumentPieces.OceanMonumentDoubleYRoom(pDirection, pDefinition);
      }
   }
   ...
   static class FitDoubleYZRoom implements OceanMonumentPieces.MonumentRoomFitter {
      ...
      public OceanMonumentPieces.OceanMonumentPiece create(Direction pDirection, OceanMonumentPieces.RoomDefinition pDefinition, Random pRandom) {
         ...
         return new OceanMonumentPieces.OceanMonumentDoubleYZRoom(pDirection, pDefinition);
      }
   }
   ...
   static class FitDoubleZRoom implements OceanMonumentPieces.MonumentRoomFitter {
      ...
      public OceanMonumentPieces.OceanMonumentPiece create(Direction pDirection, OceanMonumentPieces.RoomDefinition pDefinition, Random pRandom) {
         ...
         return new OceanMonumentPieces.OceanMonumentDoubleZRoom(pDirection, oceanmonumentpieces$roomdefinition);
      }
   }
   ...
   static class FitSimpleRoom implements OceanMonumentPieces.MonumentRoomFitter {
      ...
      public OceanMonumentPieces.OceanMonumentPiece create(Direction pDirection, OceanMonumentPieces.RoomDefinition pDefinition, Random pRandom) {
         pDefinition.claimed = true;
         return new OceanMonumentPieces.OceanMonumentSimpleRoom(pDirection, pDefinition, pRandom);
      }
   }
   ...
   static class FitSimpleTopRoom implements OceanMonumentPieces.MonumentRoomFitter {
      ...
      public OceanMonumentPieces.OceanMonumentPiece create(Direction pDirection, OceanMonumentPieces.RoomDefinition pDefinition, Random pRandom) {
         pDefinition.claimed = true;
         return new OceanMonumentPieces.OceanMonumentSimpleTopRoom(pDirection, pDefinition);
      }
   }
   ...
   public static class MonumentBuilding extends OceanMonumentPieces.OceanMonumentPiece {
      ...
      public MonumentBuilding(ServerLevel pLevel, CompoundTag pTag) {
      ...
      public boolean postProcess(WorldGenLevel pLevel, StructureFeatureManager pStructureManager, ChunkGenerator pChunkGenerator, Random pRandom, BoundingBox pBox, ChunkPos pChunkPos, BlockPos pPos) {
         ...
         for(OceanMonumentPieces.OceanMonumentPiece oceanmonumentpieces$oceanmonumentpiece : this.childPieces) {
            if (oceanmonumentpieces$oceanmonumentpiece.getBoundingBox().intersects(pBox)) {
               oceanmonumentpieces$oceanmonumentpiece.postProcess(pLevel, pStructureManager, pChunkGenerator, pRandom, pBox, pChunkPos, pPos);
            }
         }
   ...
   interface MonumentRoomFitter {
      ...
      OceanMonumentPieces.OceanMonumentPiece create(Direction pDirection, OceanMonumentPieces.RoomDefinition pDefinition, Random pRandom);
   }

   public static class OceanMonumentCoreRoom extends OceanMonumentPieces.OceanMonumentPiece {
      public OceanMonumentCoreRoom(Direction pDirection, OceanMonumentPieces.RoomDefinition pDefinition) {
         super(StructurePieceType.OCEAN_MONUMENT_CORE_ROOM, 1, pDirection, pDefinition, 2, 2, 2);
      }

      public OceanMonumentCoreRoom(ServerLevel pLevel, CompoundTag pTag) {
   ...
   public static class OceanMonumentDoubleXRoom extends OceanMonumentPieces.OceanMonumentPiece {
      public OceanMonumentDoubleXRoom(Direction pDirection, OceanMonumentPieces.RoomDefinition pDefinition) {
         super(StructurePieceType.OCEAN_MONUMENT_DOUBLE_X_ROOM, 1, pDirection, pDefinition, 2, 1, 1);
      }

      public OceanMonumentDoubleXRoom(ServerLevel pLevel, CompoundTag pTag) {
   ...
   public static class OceanMonumentDoubleXYRoom extends OceanMonumentPieces.OceanMonumentPiece {
      public OceanMonumentDoubleXYRoom(Direction pDirection, OceanMonumentPieces.RoomDefinition pDefinition) {
         super(StructurePieceType.OCEAN_MONUMENT_DOUBLE_XY_ROOM, 1, pDirection, pDefinition, 2, 2, 1);
      }

      public OceanMonumentDoubleXYRoom(ServerLevel pLevel, CompoundTag pTag) {
   ...
   public static class OceanMonumentDoubleYRoom extends OceanMonumentPieces.OceanMonumentPiece {
      public OceanMonumentDoubleYRoom(Direction pDirection, OceanMonumentPieces.RoomDefinition pDefinition) {
         super(StructurePieceType.OCEAN_MONUMENT_DOUBLE_Y_ROOM, 1, pDirection, pDefinition, 1, 2, 1);
      }

      public OceanMonumentDoubleYRoom(ServerLevel pLevel, CompoundTag pTag) {
   ...
   public static class OceanMonumentDoubleYZRoom extends OceanMonumentPieces.OceanMonumentPiece {
      public OceanMonumentDoubleYZRoom(Direction pDirection, OceanMonumentPieces.RoomDefinition pDefinition) {
         super(StructurePieceType.OCEAN_MONUMENT_DOUBLE_YZ_ROOM, 1, pDirection, pDefinition, 1, 2, 2);
      }

      public OceanMonumentDoubleYZRoom(ServerLevel pLevel, CompoundTag pTag) {
   ...
   public static class OceanMonumentDoubleZRoom extends OceanMonumentPieces.OceanMonumentPiece {
      public OceanMonumentDoubleZRoom(Direction pDirection, OceanMonumentPieces.RoomDefinition pDefinition) {
         super(StructurePieceType.OCEAN_MONUMENT_DOUBLE_Z_ROOM, 1, pDirection, pDefinition, 1, 1, 2);
      }

      public OceanMonumentDoubleZRoom(ServerLevel pLevel, CompoundTag pTag) {
   ...
   public static class OceanMonumentEntryRoom extends OceanMonumentPieces.OceanMonumentPiece {
      public OceanMonumentEntryRoom(Direction pDirection, OceanMonumentPieces.RoomDefinition pDefinition) {
         super(StructurePieceType.OCEAN_MONUMENT_ENTRY_ROOM, 1, pDirection, pDefinition, 1, 1, 1);
      }

      public OceanMonumentEntryRoom(ServerLevel pLevel, CompoundTag pTag) {
   ...
   public static class OceanMonumentPenthouse extends OceanMonumentPieces.OceanMonumentPiece {
      ...
      public OceanMonumentPenthouse(ServerLevel pLevel, CompoundTag pTag) {
   ...
   public static class OceanMonumentSimpleRoom extends OceanMonumentPieces.OceanMonumentPiece {
      ...
      public OceanMonumentSimpleRoom(Direction pDirection, OceanMonumentPieces.RoomDefinition pDefinition, Random pRandom) {
         super(StructurePieceType.OCEAN_MONUMENT_SIMPLE_ROOM, 1, pDirection, pDefinition, 1, 1, 1);
         this.mainDesign = pRandom.nextInt(3);
      }

      public OceanMonumentSimpleRoom(ServerLevel pLevel, CompoundTag pTag) {
   ...
   public static class OceanMonumentSimpleTopRoom extends OceanMonumentPieces.OceanMonumentPiece {
      public OceanMonumentSimpleTopRoom(Direction pDirection, OceanMonumentPieces.RoomDefinition pDefinition) {
         super(StructurePieceType.OCEAN_MONUMENT_SIMPLE_TOP_ROOM, 1, pDirection, pDefinition, 1, 1, 1);
      }

      public OceanMonumentSimpleTopRoom(ServerLevel pLevel, CompoundTag pTag) {
   ...
   public static class OceanMonumentWingRoom extends OceanMonumentPieces.OceanMonumentPiece {
      ...
      public OceanMonumentWingRoom(ServerLevel pLevel, CompoundTag pTag) {
