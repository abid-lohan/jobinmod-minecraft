...
public class EndCityPieces {
      ...
      if (pCounter > 8) {
         ...
         if (pSectionGenerator.generate(pStructureManager, pCounter, pPiece, pStartPos, list, pRandom)) {
            ...
            for(StructurePiece structurepiece : list) {
               ...
               StructurePiece structurepiece1 = StructureStart.findCollisionPiece(pPieces, structurepiece.getBoundingBox());
   ...
   public static class EndCityPiece extends TemplateStructurePiece {
      ...
      public EndCityPiece(ServerLevel pLevel, CompoundTag pTag) {
         super(StructurePieceType.END_CITY_PIECE, pTag, pLevel, (p_162428_) -> {
