...
public class PoolElementStructurePiece extends StructurePiece {
   ...
   public PoolElementStructurePiece(ServerLevel pLevel, CompoundTag pTag) {
      super(StructurePieceType.JIGSAW, pTag);
      this.structureManager = pLevel.getStructureManager();
      ...
      RegistryReadOps<Tag> registryreadops = RegistryReadOps.create(NbtOps.INSTANCE, pLevel.getServer().getResourceManager(), pLevel.getServer().registryAccess());
   ...
   protected void addAdditionalSaveData(ServerLevel pLevel, CompoundTag pTag) {
      ...
      RegistryWriteOps<Tag> registrywriteops = RegistryWriteOps.create(NbtOps.INSTANCE, pLevel.getServer().registryAccess());
   ...
   public boolean place(WorldGenLevel pLevel, StructureFeatureManager pStructureManager, ChunkGenerator pChunkGenerator, Random pRandom, BoundingBox pBox, BlockPos pPos, boolean pKeepJigsaws) {
