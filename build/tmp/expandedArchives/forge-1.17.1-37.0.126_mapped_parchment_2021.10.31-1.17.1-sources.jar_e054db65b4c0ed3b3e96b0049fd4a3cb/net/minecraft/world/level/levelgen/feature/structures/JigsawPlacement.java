...
public class JigsawPlacement {
   ...
   public static void addPieces(RegistryAccess pRegistry, PoolElementStructurePiece pPiece, int pMaxDepth, JigsawPlacement.PieceFactory pFactory, ChunkGenerator pChunkGenerator, StructureManager pStructureManager, List<? super PoolElementStructurePiece> pPieces, Random pRandom, LevelHeightAccessor pLevel) {
      Registry<StructureTemplatePool> registry = pRegistry.registryOrThrow(Registry.TEMPLATE_POOL_REGISTRY);
      ...
      jigsawplacement$placer.placing.addLast(new JigsawPlacement.PieceState(pPiece, new MutableObject<>(Shapes.INFINITY), 0, 0));

      while(!jigsawplacement$placer.placing.isEmpty()) {
         JigsawPlacement.PieceState jigsawplacement$piecestate = jigsawplacement$placer.placing.removeFirst();
         jigsawplacement$placer.tryPlacingChildren(jigsawplacement$piecestate.piece, jigsawplacement$piecestate.free, jigsawplacement$piecestate.boundsTop, jigsawplacement$piecestate.depth, false, pLevel);
      }
   ...
   static final class PieceState {
      ...
      PieceState(PoolElementStructurePiece pPiece, MutableObject<VoxelShape> pFree, int pBoundsTop, int pDepth) {
         this.piece = pPiece;
         this.free = pFree;
