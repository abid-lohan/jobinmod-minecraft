...
public class WoodlandMansionPieces {
   ...
   public static class WoodlandMansionPiece extends TemplateStructurePiece {
      ...
      public WoodlandMansionPiece(ServerLevel pLevel, CompoundTag pTag) {
         super(StructurePieceType.WOODLAND_MANSION_PIECE, pTag, pLevel, (p_163709_) -> {
      ...
      protected void handleDataMarker(String pFunction, BlockPos pPos, ServerLevelAccessor pLevel, Random pRandom, BoundingBox pSbb) {
         if (pFunction.startsWith("Chest")) {
            ...
            this.createChest(pLevel, pSbb, pRandom, pPos, BuiltInLootTables.WOODLAND_MANSION, blockstate);
         } else {
