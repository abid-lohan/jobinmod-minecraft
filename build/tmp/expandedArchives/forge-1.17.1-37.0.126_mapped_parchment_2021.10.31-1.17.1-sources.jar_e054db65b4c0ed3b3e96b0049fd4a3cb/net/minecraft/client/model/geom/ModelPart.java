...
public final class ModelPart {
   ...
   public static class Cube {
      ...
      public Cube(int pTexCoordU, int pTexCoordV, float pOriginX, float pOriginY, float pOriginZ, float pDimensionX, float pDimensionY, float pDimensionZ, float pGrowX, float pGrowY, float pGrowZ, boolean pMirror, float pTexWidthScaled, float pTexHeightScaled) {
         this.minX = pOriginX;
         this.minY = pOriginY;
         this.minZ = pOriginZ;
      ...
      public void compile(PoseStack.Pose pPose, VertexConsumer pVertexConsumer, int pPackedLight, int pPackedOverlay, float pRed, float pBlue, float pGreen, float pAlpha) {
         ...
         for(ModelPart.Polygon modelpart$polygon : this.polygons) {
            ...
            for(ModelPart.Vertex modelpart$vertex : modelpart$polygon.vertices) {
               ...
               pVertexConsumer.vertex(vector4f.x(), vector4f.y(), vector4f.z(), pRed, pBlue, pGreen, pAlpha, modelpart$vertex.u, modelpart$vertex.v, pPackedOverlay, pPackedLight, f, f1, f2);
            }
         }
