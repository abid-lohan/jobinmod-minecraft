...
public class Gui extends GuiComponent {
   ...
   protected void renderCrosshair(PoseStack pMatrixStack) {
      ...
      if (!collection.isEmpty()) {
         ...
         for(MobEffectInstance mobeffectinstance : Ordering.natural().reverse().sortedCopy(collection)) {
            ...
            if (mobeffectinstance.showIcon()) {
               ...
               renderer.renderHUDEffect(mobeffectinstance,this, pMatrixStack, k, l, this.getBlitOffset(), f);
            }
         }
   ...
   protected void renderHotbar(float pPartialTicks, PoseStack pMatrixStack) {
